...
class ConfigurePyQt4:
    ...
    def code(self):
        ...
        if "QtDesigner" in pyqt_modules:
            qpy_inc_dir, qpy_lib_dir = self._qpy_directories("QtDesigner")
...
""")
    ...
    def _qpy_directories(self, mname):
        ...
        library for the support library for the given module.
